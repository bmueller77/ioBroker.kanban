    ...
    async reassignUser(from, to, source) {
        ...
        for (const board of this.boards.values()) {
            ...
            if (Array.isArray(board.members) && board.members.includes(alt)) {
                ...
                beruehrt = true;
            } else if (beruehrt && Array.isArray(board.members) && board.members.length && !board.members.includes(neu)) {
...
module.exports = { Store, todayStr, nextDue, recMatches, nextCronDates, TRASH_RETENTION_DAYS };
