...
class Server {
    ...
    _apiRoutes(app) {
        ...
        app.post('/api/boards/:id/cards/:cardId/restore', wrap(async (req, res) => {
            ...
            res.json(this.store.restoreCard(req.params.id, req.params.cardId, columnId, by || 'api'));
        }));

        app.post('/api/boards/:id/cards/:cardId/purge', wrap(async (req, res) => {
            res.json(this.store.purgeCard(req.params.id, req.params.cardId, (req.body && req.body.by) || 'api'));
        }));
        ...
        app.post('/api/boards/:id/cards/:cardId/transfer', wrap(async (req, res) => {
            ...
            res.json(this.store.transferCard(req.params.id, req.params.cardId, toBoard, toColumn,
