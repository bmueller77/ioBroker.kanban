...
- **0.3.0**
  ...
  - The same dialog can **clone a card in place**: pick the current board as the target and the card is duplicated with all its content directly below the original
