...
| `settings-boards.png` | Board-Manager, Tab *Boards* (Mitglieder je Board) | ⚙ |
...
| `admin-email.png` | Instanzeinstellungen, Tab *E-Mail* | ioBroker-Admin |
| `mobile.jpg` | Mobile Ansicht (gestapelte Spalten) | Smartphone |
| `mobile-drag.png` | Mobile Ansicht – Schnellmenü beim Ziehen einer Karte | Smartphone |
